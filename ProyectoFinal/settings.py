...
SECRET_KEY = 'django-insecure-j+s(m&ylo(^(p_2g!qvb(h_82wlc0k0ziajp6s&(8(r!2q_*8+'
...
SOCIALACCOUNT_PROVIDERS = {
    'google': {
        ...
        # credentials, or list them here:
        'APP': {
            'client_id': '174867670467-j2lsv40tqk72oj07hte6itjv8v2h3osh.apps.googleusercontent.com',
            'secret': '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',
            'key': ''
        }
    }
}
